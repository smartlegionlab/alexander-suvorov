class VerticalProgressNav {
    ...
    createProgressBar() {
        ...
        const sections = ['hero', 'about', 'research', 'expertise', 'publications', 'contact'];
        const labels = ['Home', 'About', 'Research', 'Expertise', 'Publications', 'Contact'];
    ...
    setupSections() {
        this.sections = [
            'hero', 'about', 'research', 'expertise', 'publications', 'contact'
